...
public class MathImplicitFunctionOperations extends MathBase {
    ...
    MathImplicitFunctionOperations(int dimension, String pathToPoints, MathImplicitFunction function) throws FileNotFoundException
    {
    ...
    MathImplicitFunctionOperations()
    {
        this.dimension = 1;
        this.points = new ArrayList<>();
    ...
    {
        System.out.println(Main.HEADER_OUTPUT + "Частная Производная Функции по переменной x" + index + " в каждой точке:" + Main.RESET);
        for (PointMultiD point : this.points)
